...
Do not use the traditional `build_model` flow for detached-house design output. When the user wants structural analysis, call `detached_house_build_analysis_model` first, then use the normal validation and analysis tools.
